...
-- AddForeignKey
ALTER TABLE "JobApplicationStatus" ADD CONSTRAINT "JobApplicationStatus_jobApplicationId_fkey" FOREIGN KEY ("jobApplicationId") REFERENCES "JobApplication"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
